...
![三种方式绘制矩形](/IMAGES/Canvas-基础用法/三种方式绘制矩形.png)
...
![绘制三角形](/IMAGES/Canvas-基础用法/绘制三角形.png)
