...
![三种方式绘制矩形](https://cdn.jsdelivr.net/gh/chanshiyucx/poi/2019/三种方式绘制矩形.png)
...
![绘制三角形](https://cdn.jsdelivr.net/gh/chanshiyucx/poi/2019/绘制三角形.png)
...
![笑脸](https://cdn.jsdelivr.net/gh/chanshiyucx/poi/2019/笑脸.png)
...
![二次贝塞尔曲线](https://cdn.jsdelivr.net/gh/chanshiyucx/poi/2019/二次贝塞尔曲线.gif)

canvas API `bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y)`，用来绘制三次贝塞尔曲线，`cp1x,cp1y` 为控制点一，`cp2x,cp2y` 为控制点二，`x,y` 为结束点。

![三次贝塞尔曲线](https://cdn.jsdelivr.net/gh/chanshiyucx/poi/2019/三次贝塞尔曲线.gif)
