...
- **während** (在…期间)
	- _Während er arbeitete, hörte er Musik._
- **bevor/ehe** (在…之前)
	- _Bevor ich schlafe, putze ich mir die Zähne._
	- (睡觉前，我刷牙。)
- **nachdem** (在…之后)
	- _Nachdem wir gegessen hatten, gingen wir spazieren._
	- (吃完饭后，我们去散步。)
- **seit(dem)** (自从…)
	- _Seit(dem) ich hier wohne, fühle ich mich wohl._
	- (自从我住在这里，我感觉很舒适。)
- **bis** (直到…)
	- _Ich warte, bis du kommst._
	- (我等到你来。)
- **solange** (只要…)
	- _Solange es nicht regnet, können wir draußen bleiben._
	- (只要不下雨，我们就可以待在外面。)
...
- **weil** (因为)
	...
	- _Ich lerne Deutsch, weil ich nach Deutschland ziehen möchte._
	- (我学德语，因为我想搬到德国。)
- **da** (因为，通常置于句首)
	
	- _Da es regnet, bleiben wir zu Hause._
	- (因为下雨，我们呆在家里。)
...
- **wenn** (如果)
	...
	- _Wenn es morgen regnet, bleibe ich zu Hause._
	- (如果明天下雨，我就呆在家里。)
- **falls** (万一，以防)
	
	- _Falls du Zeit hast, könntest du mir helfen?_
	- (万一你有时间，你能帮我吗？)

#### 目的从句 (Finalsätze)

- **damit** (为了，以便)
	- _Ich spreche langsam, damit du mich verstehst._
	- (我说得慢，这样你就能听懂我。)
...
- **obwohl/obgleich** (尽管)
	...
	- _Obwohl es regnete, ging er ohne Regenschirm aus._
	- (尽管下雨，他还是没带伞出门。)
- **trotzdem** (尽管，作为从属连词时)
	
	- _Trotzdem es regnete, ging er spazieren._
	- (尽管下雨，他还是去散步了。)
