[pixiv: 70977889]: # 'https://i.loli.net/2019/04/15/5cb456faa2982.jpg'

Flex 弹性布局是我项目中使用频率最多的布局方式，基本任何涉及到布局样式时采用的第一方案就是 Flex，虽说弹性布局用得多，但是对一些不常用的属性还是知之甚少，故在此温故知新。
...
![Can I Use Flex](https://i.loli.net/2019/04/15/5cb438c5d6aa6.png)
