常言道不学正则，无成大事。正则表达式一直是我的弱项，工作中需要正则都是棘手万分，能够优雅解决的问题最后都是一笔烂账，对正则虽避之不及却又无法割舍，痛之又痛。<!-- more -->
...
括号提供了分组，用于引用。引用分两种：在 JavaScript 里引用和在正则里引用。

### 分组和分支结构

分组和分支结构是括号最直接的功能，强调括号内是一个整体，即提供子表达式。
...
![惰性正则回溯](https://i.loli.net/2019/01/05/5c308390ac538.png#full)
