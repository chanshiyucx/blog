[pixiv: 47707282]: # 'https://i.loli.net/2019/02/18/5c6a1bc756005.jpg'

canvas 是一个可以使用脚本（通常为 JavaScript）来绘制图形的 HTML 元素。它可以用于绘制图表、制作图片构图或者制作简单的（以及不那么简单的）动画。此篇是学习 canvas 基础用法所作摘要。
