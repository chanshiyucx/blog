[anime.js](http://animejs.com/) 是一个强大的 JavaScript 动画库，HeartBeat 主题的背景点击特效就是借用其官网展示效果，相当酷炫。为了学习动画库的使用，这里用 ES6 重构了烟火代码，来一场不一样的烟火。<!-- more -->
...
- [Github](https://github.com/chanshiyucx/treasure/tree/master/firework)
- [在线预览](https://chanshiyu.com/treasure/firework/)
