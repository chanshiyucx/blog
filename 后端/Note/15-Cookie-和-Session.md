...
> 本文为个人学习摘要笔记。  
> 原文地址：[你真的了解 Cookie 和 Session 吗](http://www.justdojava.com/2019/05/12/cookie-session/)
...
可以使用 Token 机制。Token 机制多用于 App 客户端和服务器交互的模式，也可以用于 Web 端做用户状态管理。
